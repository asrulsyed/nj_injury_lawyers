        ...
        <> {
            loading ? <div className="w-full h-[900px] flex flex-col items-center justify-center gap-5">
                <div role="status">
                    ...
                    <span className="sr-only text-color1 text-3xl">Loading...</span>
                </div>
                <h1 className="text-3xl">Sending Message...</h1>
            </div> : <div className="form-bg w-full min-h-screen flex md:flex-row flex-col justify-between items-center">
                <div className="md:w-[57%] w-[95%] flex flex-col items-center text-center py-16">
                    <h1 className="font-bold text-[white] text-6xl">INJURY LAYWERS</h1>
                    <p className="pt-3 font-bold text-2xl text-[white]">Referral Portal For The Seriously Injured</p>
                    <p className="pt-10 font-bold text-[26px] text-[white]">Briefly Describe Your Case to Connect with a Top Lawyer</p>
                </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col w-full justify-between">
                            <Form.Item name={['period']}
                                label={<p className=" text-xl font-bold text-[white]">How long ago did the accident happen?</p>}
                                rules={[{ required: true }]}
                            // style={{ width: '48%' }}
                            >
                            ...
                            <Form.Item name={['medical']}
                                label={<p className="font-bold text-[white] text-xl">Did the injury require hospitalization, medical treatment, or surgery?</p>}
                                rules={[{ required: true }]}
                            // style={{ width: '48%' }}
                            >
                                <select className="w-full h-[40px] outline-none rounded-[5px] text-base pl-2">
                        ...
                        <div className="flex flex-col w-full justify-between">
                            <Form.Item name={['fault']}
                                label={<p className="font-bold text-[white] text-xl">Were you at fault for the accident?</p>}
                                rules={[{ required: true }]}
                            // style={{ width: '45%' }}
                            >
                                <select className="w-full h-[40px] outline-none rounded-[5px] text-base pl-2">
                        ...
                        <div className="flex flex-col w-full justify-between">
                            <Form.Item name={['stay']}
                                label={<p className="font-bold text-[white] text-xl">What is the primary type of injury?</p>}
                                rules={[{ required: true }]}
                            // style={{ width: '48%' }}
                            >
                                <select className="w-full h-[40px] outline-none rounded-[5px] text-base pl-2">
