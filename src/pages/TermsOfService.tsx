    ...
    return (
        <>
            <div className="w-full h-screen bg-gray-300 pb-10">
                <div className="terms w-full flex flex-col py-16 items-center justify-center h-[200px] md:h-[400px]">
                    <div className="text-6xl md:text-[100pt] text-center text-[white] tracking-wide">Terms of Service</div>
                </div>
                <div className="w-full bg-gray-300 flex justify-center pt-16">
